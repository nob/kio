...
?>
    ...
    <div id="products-pane" class="pane">
        ...
        <div class="content">
            ...
            <ul id="catalogs">
                <li><a href="catalog/kimono+yukata+happi_v15.pdf" rel="#pdf-1">Kimono, Yukata & Happi</a></li>
                <li><a href="catalog/kids-yukata+jinbei_v14.pdf" rel="#pdf-2">Kid's Yukata & Jinbei</a></li>
