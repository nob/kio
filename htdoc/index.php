    ...
    <div id="products-pane" class="pane">
        ...
        <div class="content">
            ...
            <ul id="catalogs">
                ...
                -->
                <li><a href="catalog/kimono_2012_v20.pdf" target="_blank">Kimono 2012</a></li>
                <li>
                    ...
                    -->
                    <li><a href="catalog/paper_craft_j_scene_v20.pdf" target="_blank">Japanese Scene series</a></li>
                    <!--
                    <li><a href="catalog/paper_craft_diorama_v20.pdf" rel="#pdf-3">Diorama series</a></li>
                    -->
                    <li><a href="catalog/paper_craft_diorama_v20.pdf" target="_blank">Diorama series</a></li>
                    <!--
                ...
                -->
                <li><a href="catalog/paper_goods_2012_v20.pdf" rel="#pdf-5" target="_blank">Paper goods 2012</a></li>
            <ul>
        </div>
    </div>
